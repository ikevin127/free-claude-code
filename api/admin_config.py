...
SECTIONS: tuple[ConfigSectionSpec, ...] = (
    ...
    ConfigSectionSpec(
        "multi_instance",
        "Multi-Instance",
        "Run multiple Claude Code instances with different keys, models, and ports.",
        advanced=False,
    ),
)
...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "NVIDIA NIM API Key 2",
        "multi_instance",
        "secret",
        settings_attr="nvidia_nim_api_key_2",
        secret=True,
        description="API key for the second Claude Code instance.",
    ),
    ConfigFieldSpec(
        "MODEL_2",
        "Instance 2 Default Model",
        "multi_instance",
        settings_attr="model_2",
        default="",
        description="Fallback model for instance 2 (format: provider_type/model/name).",
    ),
    ConfigFieldSpec(
        "MODEL_OPUS_2",
        "Instance 2 Opus",
        "multi_instance",
        settings_attr="model_opus_2",
        default="",
        description="Opus model for instance 2.",
    ),
    ConfigFieldSpec(
        "MODEL_SONNET_2",
        "Instance 2 Sonnet",
        "multi_instance",
        settings_attr="model_sonnet_2",
        default="",
        description="Sonnet model for instance 2.",
    ),
    ConfigFieldSpec(
        "MODEL_HAIKU_2",
        "Instance 2 Haiku",
        "multi_instance",
        settings_attr="model_haiku_2",
        default="",
        description="Haiku model for instance 2.",
    ),
    ConfigFieldSpec(
        "PORT_2",
        "Instance 2 Port",
        "multi_instance",
        "number",
        settings_attr="port_2",
        default="4002",
        description="Port for instance 2 proxy.",
    ),
    # --- Instance 3 ---
    ConfigFieldSpec(
        "NVIDIA_NIM_API_KEY_3",
        "NVIDIA NIM API Key 3",
        "multi_instance",
        "secret",
        settings_attr="nvidia_nim_api_key_3",
        secret=True,
        description="API key for the third Claude Code instance.",
    ),
    ConfigFieldSpec(
        "MODEL_3",
        "Instance 3 Default Model",
        "multi_instance",
        settings_attr="model_3",
        default="",
        description="Fallback model for instance 3 (format: provider_type/model/name).",
    ),
    ConfigFieldSpec(
        "MODEL_OPUS_3",
        "Instance 3 Opus",
        "multi_instance",
        settings_attr="model_opus_3",
        default="",
        description="Opus model for instance 3.",
    ),
    ConfigFieldSpec(
        "MODEL_SONNET_3",
        "Instance 3 Sonnet",
        "multi_instance",
        settings_attr="model_sonnet_3",
        default="",
        description="Sonnet model for instance 3.",
    ),
    ConfigFieldSpec(
        "MODEL_HAIKU_3",
        "Instance 3 Haiku",
        "multi_instance",
        settings_attr="model_haiku_3",
        default="",
        description="Haiku model for instance 3.",
    ),
    ConfigFieldSpec(
        "PORT_3",
        "Instance 3 Port",
        "multi_instance",
        "number",
        settings_attr="port_3",
        default="4003",
        description="Port for instance 3 proxy.",
    ),
)
